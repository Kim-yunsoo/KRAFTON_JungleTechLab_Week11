...
UAnimInstance::UAnimInstance(USkeletalMeshComponent* InOwner) : OwnerComponent(InOwner)
{
...
void UAnimInstance::SetAnimation(UAnimSequence* InSequence, bool IsInit = true)
{
